defmodule Explorer.Indexer.BufferedTask do
  @moduledoc """
  TODO
  """
  use GenServer
  ...
  @callback init_stream(initial :: term, reducer :: function) ::
  ...
  def buffer(server, entry) do
    GenServer.cast(server, {:buffer, entry})
  end

  def start_link(base_opts) do
  ...
  def handle_cast({:buffer, entries}, state) do
